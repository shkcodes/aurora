...
// from https://github.com/Zhuinden/fragmentviewbindingdelegate-kt/issues/8
...
class ViewBindingDelegate<T : ViewBinding>(
    ...
    override fun getValue(thisRef: Fragment, property: KProperty<*>): T {
        ...
        if (!lifecycle.currentState.isAtLeast(Lifecycle.State.INITIALIZED)) {
            throw IllegalStateException("Should not attempt to use the binding until onCreateView() is called")
        }
